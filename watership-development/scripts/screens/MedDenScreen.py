    ...
    def screen_switches(self):
        ...
        if self.meds:
            ...
            if herb_amount == 0:
                ...
                if len(self.meds) == 1:
                    med_concern = f"Inle has blessed them with plentiful herbs and the healer sends their thanks to Silverpelt."
                else:
                    med_concern = f"Inle has blessed them with plentiful herbs and the healers send their thanks to Silverpelt."
