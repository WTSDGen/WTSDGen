...
class StartScreen(Screens):
    ...
    def handle_event(self, event):
        ...
        if event.type == pygame_gui.UI_BUTTON_START_PRESS:
            screens = {
                ...
                self.switch_warren_button: 'switch warren screen',
                self.new_warren_button: 'make warren screen',
            ...
            if event.ui_element in screens:
                ...
                if platform.system() == 'Darwin':
                    subprocess.Popen(
                        ["open", "-u", "https://discord.gg/warrengen"])
                elif platform.system() == 'Windows':
                    os.system(f"start \"\" {'https://discord.gg/warrengen'}")
                elif platform.system() == 'Linux':
                    subprocess.Popen(
                        ['xdg-open', "https://discord.gg/warrengen"])
            elif event.ui_element == self.social_buttons['tumblr_button']:
                if platform.system() == 'Darwin':
                    subprocess.Popen(
                        ["open", "-u", "https://officialwarrengen.tumblr.com/"])
                elif platform.system() == 'Windows':
                    os.system(
                        f"start \"\" {'https://officialwarrengen.tumblr.com/'}")
                elif platform.system() == 'Linux':
                    subprocess.Popen(
                        ['xdg-open', "https://officialwarrengen.tumblr.com/"])
            elif event.ui_element == self.social_buttons['twitter_button']:
                if platform.system() == 'Darwin':
                    subprocess.Popen(
                        ["open", "-u", "https://twitter.com/OfficialWarrengen"])
                elif platform.system() == 'Windows':
                    os.system(
                        f"start \"\" {'https://twitter.com/OfficialWarrengen'}")
                elif platform.system() == 'Linux':
                    subprocess.Popen(
                        ['xdg-open', "https://twitter.com/OfficialWarrengen"])
    ...
    def exit_screen(self):
        ...
        self.switch_warren_button.kill()
        self.new_warren_button.kill()
    ...
    def screen_switches(self):
        ...
        self.continue_button = UIImageButton(scale(
            ...
            manager=MANAGER)
        self.switch_warren_button = UIImageButton(
            scale(pygame.Rect((140, 710), (384, 70))),
            "",
            object_id="#switch_warren_button",
            manager=MANAGER)
        self.new_warren_button = UIImageButton(scale(
            pygame.Rect((140, 800), (384, 70))),
            "",
            object_id="#new_warren_button",
            manager=MANAGER)
        ...
        self.error_gethelp = pygame_gui.elements.UITextBox(
            ...
            '<br><a href="https://discord.gg/warrengen">Discord</a>',  # pylint: disable=line-too-long
        ...
        try:
            ...
            if not get_version_info().is_source_build and not get_version_info().is_itch and get_version_info().upstream.lower() == "WarrenGenOfficial/warrengen".lower() and \
        ...
        self.warning_label = pygame_gui.elements.UITextBox(
            "Warning: this game includes descriptions of gore, violence, and animal abuse",
        ...
        if len(game.switches['warren_list']) > 1:
            self.switch_warren_button.enable()
        else:
            self.switch_warren_button.disable()
        ...
        if game.warren is not None:
            ...
            for x in key_copy:
                if x not in game.warren.warren_rabbits:
                    game.warren.remove_rabbit(x)
