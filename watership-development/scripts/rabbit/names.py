...
class Name():
    ...
    def give_prefix(self, eyes, colour, biome):
        # decided in game config: rabbit_name_controls
        if game.config["rabbit_name_controls"]["always_name_after_appearance"]:
        ...
        if game.config["rabbit_name_controls"]["allow_eye_names"]: # game config: rabbit_name_controls
    ...
    def __repr__(self):
        ...
        elif self.status in self.names_dict["special_suffixes"] and self.specsuffix_hidden:
            return self.prefix
        else:
